                ...
                <ul>
                    ...
                    <li class="active">
                        <a href="#" class="link">
                            ...
                            <img src="../assets/img/icones/blanc-6.png"> <span>Contact</span>
                            </router-link>
                        </a>
                    </li>
                    <li class="">
        ...
        <section class="main">
                <div class="container">
                        ...
                        <div class="contenu-terminaux">
                            <h4 class="title color-white">Nous contacter</h4>
                            <br/>
                            <div class="contact">
                                <div class="contact-left">
                                    <form>
                                        ...
                                        <div class="form-textarea">
                                            ...
                                            <textarea type="text" name="nom"></textarea>
                                        </div>
                                        
                                        <div class="form-radio">
                                            <input id="myradio" type="checkbox" name="myradio">
                                            <label for="myradio">Je certifie avoir pris connaissance et accepte les conditions relatives à la protection de la Vie Privée.</label>
                                        </div>
                                ...
                                <div class="contact-right">
                                    <br/><br/><br/>
                                    Besoin de nous contacter?<br/>
                                    Contactez notre support client
                                    <br/><br/>
                                    +32 2 318 18 25
                                    <br/><br/>
                                    customer.support@inocrea.be
                                    <br/><br/>
                                    Rue des trois Arbres, 62 bte 28
